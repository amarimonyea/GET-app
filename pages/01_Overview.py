    ...
    },
    {
    ...
    },
     {
    ...
    },
      {
        ...
        "probability": "",
        "summary": "Net Assessment: The US experienced the longest government shutdown in history, significantly undermining economic stability. SNAP and WIC programs were highly stressed, prompting several states to draw on emergency funding. The gender wage gap widened for the second consecutive year, compounding inequality for female-headed households and women of color. President Trump targeted political adversaries, including high-profile black women in legal/institutional roles, reinforcing gendered and racialized pressure. A Young Republicans group chat revealed extreme racist and misogynistic rhetoric with Hitler references; while no formal legal action followed, public outrage led to resignations, highlighting mainstreaming of manosphere rhetoric within US politics. Major corporations aligned with the Trump Administration, removing gender identity and diversity programs, leading to large-scale layoffs and workforce instability. October announcement of IVF expansion through trumprx.gov not expected to launch until 2026. Access to gender-affirming care heavily restricted nationwide, with penalties for practitioners. Mass deportation caused mistreatment of women, queer, and trans individuals in detention, with claims of sexual assault, medical neglect, and forced labor. Social freedoms continued to erode throughout 2025 amid volatile political environment and normalized exclusionary discourse. Key legal precedents weakened, including same-sex marriage protections and Voting Rights Act elements. Trump Administration faced 249 active lawsuits by Q4."
    },
]
