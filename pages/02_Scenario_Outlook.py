...
FORECAST_CARDS = [
    ...
    },
    {
    ...
    },
     {
        ...
        "direction": "Improving",
        "probability": "Low (5-25%)",
        "summary": "This forecast reflects increased investment in evidence-based research, public universities, and workforce development programs that advance gender equity and economic inclusion for LGBTQ+ individuals, women, and marginalized communities. Federal support for childcare, paid family leave, and equitable wages strengthens economic participation. Continuity of federal programs addressing economic vulnerability ensures sustained opportunity access for all marginalized populations.",
        "implications": ["Expanded economic opportunities for LGBTQ+, women, and marginalized communities", "Sustained continuity of federal support programs (childcare, workforce development)", "Strengthened institutional capacity to address gender-driven economic inequities"]
    },
     {
        "name": "Economic", 
        "direction": "Deteriorating",
        "probability": "Low/Medium (25-40%)",
        "summary": "This forecast illustrates how cuts to federal research funding and defunding of equity-focused institutions disrupt workforce diversity initiatives and limit economic opportunities for LGBTQ+ individuals, women, and marginalized communities. Reductions or elimination of federal supports for childcare, paid leave, and income assistance programs disproportionately harm these populations. Loss of continuity in federal programs weakens economic resilience and widens inequality.",
        "monitoring_indicators": ["Cuts or divestments in federal scientific, evidence-based research, or mass media related to gender, LGBTQ+, or social policy", "Decreased funding for public universities focused on social science research", "Reductions in federal childcare, workforce development, or income support programs"],
        "implications": ["Reduced economic opportunities for LGBTQ+, women, and marginalized communities", "Disruption of federal program continuity (childcare, SNAP, housing support)", "Disproportionate economic burden on vulnerable families"]
    },
     {
        "name": "Social", 
        "direction": "Deteriorating",
        "probability": "Medium/High (60-75%)",
        "summary": "This forecast illustrates how restrictive reproductive and gender policies create medical and ethical crises affecting women's healthcare, maternal mortality, family planning, and gender-affirming care access. Reductions in federal support for preventive health services, contraception access, and gender-affirming care weaken continuity for women, LGBTQ+, and marginalized communities. Service withdrawal driven by fear and institutional pauses compounds discrimination across all vulnerable populations, limiting civic participation and social support.",
        "monitoring_indicators": ["Medical and ethical crises emerging from reproductive and gender policy restrictions", "Service withdrawal affecting women's preventive health, contraception, reproductive, and gender-affirming care", "Reduction in federal healthcare or social support program funding", "Service denial driven by anticipated legal, financial, or political retaliation"],
        "implications": ["Increased maternal mortality and reproductive health crises for women", "Disruption of gender-affirming care and healthcare continuity for LGBTQ+ individuals", "Compounding discrimination affecting women, trans, gender-diverse, and marginalized individuals"]
    },
      {
        "name": "Social", 
        "direction": "Improving",
        "probability": "Low (5-25%)",
        "summary": "This forecast envisions the establishment or reinstatement of comprehensive healthcare and social support programs serving women, LGBTQ+, and marginalized communities. Restoration of federal support for preventive health, maternal care, reproductive services, and gender-affirming healthcare strengthens institutional commitment to equity. Continuity of social safety net programs and protection systems rebuilds community trust and reverses discrimination trends across all marginalized populations.",
        "monitoring_indicators": ["Establishment or reinstatement of equity-oriented healthcare and social protection programs", "Restoration of federal support for preventive health, contraception, maternal care, reproductive, and gender-affirming services", "Continuity or expansion of social safety net programs (healthcare, housing support, family services)"],
        "implications": ["Restored access to comprehensive healthcare for women, LGBTQ+, and marginalized communities", "Strengthened federal program continuity supporting social and reproductive equity", "Reversal of discrimination trends and restored community trust"]
    },
          {
        "name": "Security", 
        "direction": "Improving",
        "probability": "Low (5-25%)",
        "summary": "This forecast reflects rollback of national security laws targeting gender identity, based on sex, and LGBTQ+ status, with increased inclusion of women and LGBTQ+ voices in security policymaking. Institutional recognition of intersectional security vulnerabilities—including impacts on women's, LGBTQ+, and marginalized advocacy organizations and civil liberties—strengthens national resilience and democratic protection.",
        "monitoring_indicators": ["Rollback of national laws targeting gender identity, LGBTQ+ status, and based on sex", "Inclusion of women and LGBTQ+ diverse voices in national security policymaking spaces", "Elimination of surveillance targeting civil rights, women's, and LGBTQ+ organizations"],
        "implications": ["Protection of civil liberties for women, LGBTQ+, and marginalized communities", "Stronger national security through inclusive policymaking", "Rollback of surveillance targeting civil rights, women's, and LGBTQ+ organizations"]
    },
        {
        "name": "Security", 
        "direction": "Deteriorating",
        "probability": "Medium (40-60%)",
        "summary": "This forecast illustrates how national security laws targeting gender identity and based on sex expand surveillance of civil rights, women's, and LGBTQ+ advocacy organizations and criminalize vulnerable populations. Surveillance of healthcare providers, social service organizations, and community groups weakens institutional support systems and expands state control over marginalized communities, limiting civic participation and democratic engagement.",
        "monitoring_indicators": ["National security laws targeting gender identity, LGBTQ+ status, and based on sex", "Expansion of state surveillance on women's rights, LGBTQ+ rights, and marginalized advocacy organizations", "Surveillance or criminalization of healthcare providers and social service organizations serving marginalized populations"],
        "implications": ["Curtailment of civil liberties and democratic participation for LGBTQ+ and marginalized communities", "Weakened institutional support systems for women, LGBTQ+, and marginalized communities", "Chilling effects on civic engagement and collective advocacy"]
    },
     {
        "name": "Hybrid Political/Security", 
        "direction": "Deteriorating",
        "probability": "Medium (40-60%)",
        "summary": "This forecast illustrates how political decisions drive removal of qualified personnel from defense and security sectors based on sexual orientation, gender identity, or sex, including systematic exclusion of women and LGBTQ+ individuals from security roles. Expanded surveillance and criminalization of healthcare providers and advocacy organizations serving women, LGBTQ+, and marginalized populations creates cascading institutional vulnerabilities. Political purges coupled with security-based constraints undermine both institutional capacity and civil liberties.",
        "monitoring_indicators": ["Removal of qualified personnel from national security sectors due to sexual orientation, gender identity, or sex", "Systematic restriction of women and LGBTQ+ individuals from security or defense roles", "Increased surveillance and criminalization of healthcare providers and advocacy organizations serving marginalized communities"],
